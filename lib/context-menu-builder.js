      ...
      let learnWord = new MenuItem({
        ...
        click: (() => {
          var _ref2 = _asyncToGenerator(function* () {
            ...
            setTimeout(function () {
              return target.replaceMisspelling(menuInfo.selectionText);
            }, 0);

            try {
              if (process.platform === 'darwin') {
                yield _this4.spellCheckHandler.currentSpellchecker.add(menuInfo.misspelledWord);
              } else {
                _this4.spellCheckHandler.winUserWords = yield (0, _utility.addWinUserWord)(menuInfo.misspelledWord);
              };
            } catch (e) {
